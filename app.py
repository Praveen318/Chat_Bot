...
# def add_query_to_history(history, txt, img_path):
#     if not img_path:
...
# def generate_llm_response(history, text, img_path, target_language):
#     try:
#         if not img_path:
...
#     text_box = gr.Textbox(placeholder="Enter text and press enter, or upload an image", container=True)
...
#         [chatbot, text_box, image_box, language_dropdown], 
#         chatbot
#     )
...
with gr.Blocks() as app:
    ...
    submit_button.click(
        ...
        inputs=[chatbot, text_box, image_box, language_dropdown], 
        outputs=chatbot
    )
